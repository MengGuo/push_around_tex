...
\begin{figure}
  ...
  \vspace{-10mm}
\caption{SL-Push. Computate(offline) or simulate(sim-in-the-loop) the push directions for movable obstacles along the W-width straight path from sub-start to sub-goal. Top: Push steps. Bottom: Changes in the reachable region during pushes}
\end{figure}
...
\begin{figure}
  ...
  \vspace{-10mm}
\caption{Rec-NAMO. Rec-NAMO builds path segments sequentially but fails to construct the full width-w path from start to goal. Top: Push steps. Bottom: Changes in the reachable region during pushes}
\end{figure}
