...
decreases or a fixed evaluation budget is reached.
...
combinations (with a fixed budget) attempts the full-team assignment. If no feasible full-team mode is found
...
\begin{figure}[t!]
  \centering
  \includegraphics[width=0.9\linewidth]{figures/PIHS_bottom.pdf}
  \vspace{-2mm}
