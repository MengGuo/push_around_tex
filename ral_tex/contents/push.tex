...
while a few angular components are included to account for local geometry.
These directions reflect the candidate pushing intents for the obstacles adjacent
to gap~$g$, as shown in Fig.~\ref{fig:direct_recursive_push}.
...
As illustrated in Fig.~\ref{fig:mode_generation}, a strategy is
