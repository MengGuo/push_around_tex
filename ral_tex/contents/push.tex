...
decreases. \change{A bounded backtracking variant removes the robot-order
sensitivity of this replacement. If no full-team assignment exists for a task,
e.g., on small faces or under the pairwise pusher-clearance constraint, one
robot is released for that single push (charged a penalty when ranking modes, so
...
\begin{figure}[t!]
  \centering
  \includegraphics[width=0.85\linewidth]{figures/PIHS_bottom.pdf}
  \vspace{-2mm}
