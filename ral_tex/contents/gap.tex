...
\begin{figure}[t!]
  ...
  \vspace{-0.1in}
  \caption{\change{
  \textbf{Direct pushing (Top)} moves a gap-side blocker along a gap-opening
  direction, whereas \textbf{recursive pushing (Bottom)} first clears movable
  blockers in the swept region and then returns to the root gap-opening task.}}
