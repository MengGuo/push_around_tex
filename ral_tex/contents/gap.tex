...
Lastly, a short A$^\star$-style presearch crosses
each candidate gap, recomputes the next frontier, and continues for a limited
beam width and depth. The \emph{cost-to-connect} is predicted by:
...
the runtime of ranking remains negligible compared to
