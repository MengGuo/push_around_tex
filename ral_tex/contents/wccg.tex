...
A W--Clearance Connectivity Graph (WCCG) is introduced in this work and shown Fig.~\ref{fig:wccg}),
which encodes obstacle adjacencies under clearance $W$ and enables fast connectivity queries.
...
disk of radius $W/2$. The criterion for the  existence of a $W$--clear path
$\mathcal{P}^W_\texttt{V}$ is given by:
