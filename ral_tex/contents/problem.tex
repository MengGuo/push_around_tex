...
pushing transitions. Equation~\eqref{eq:problem} ranks feasible schedules;
PIHS uses finite sampling and does not guarantee global optimality of the
continuous hybrid objective.

% ==============================
\begin{remark}\label{remark:uniqueness}
  \change{The objective and constraints above couple obstacle selection, pushing-mode generation, and switching in a single hybrid planning problem. The resulting combinatorial-continuous search space is substantially richer than classical NAMO formulations with simple objects or hand-crafted contact modes~\cite{goyal1989limit,chen2015occlusion,wang2006multi}.}
  \hfill~$\blacksquare$
\end{remark}
% ==============================
