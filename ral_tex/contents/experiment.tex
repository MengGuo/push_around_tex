...
PushAround maintains a $100\%$ success rate for all $M\in[15,45]$ at $2.5$--$53.4$\,s
of planning, whereas at $M{=}45$ the external methods solve none of the trials and
the no-recursion ablation solves $7/10$.
...
\begin{figure*}[t!]
  \centering
  \includegraphics[width=0.89\linewidth]{figures/hardware.png}
  \vspace{-2mm}
