...
procedure with a full-team-first fallback in which one robot may be temporarily inactive. At $N{=}4$, PushAround uses $29.2$\,s planning and $110.1$\,s execution against $101.9$\,s and $175.9$\,s for DFS-WCCG.\,s for DFS-WCCG.
