...
procedure with a full-team-first fallback that may leave one robot temporarily inactive. At $N{=}4$, PushAround uses $29.2$\,s planning and $110.1$\,s execution against $101.9$\,s and $175.9$\,s for DFS-WCCG.
...
per generated mode. Across the tested $N{=}2$--$4$ cases, the observed search structure is nearly
unchanged ($10$ expansions, $60$--$63$ simulations), while the aggregate
mode-generation time triples from $15.8$ to $46.4$\,s.
