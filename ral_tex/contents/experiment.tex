...
The simulation runs at a step size of $\Delta t=1/120$\,s with a control period
...
procedure with a full-team-first fallback in which one robot may be temporarily inactive. At $N{=}4$, PushAround uses $29.2$\,s planning and $110.1$\,s execution against $101.9$\,s and $175.9$\,s for DFS-WCCG.
...
succeeds in $156$ of the $160$ perturbed trials, a success rate of $97.5\%$; under $\pm40\%$
