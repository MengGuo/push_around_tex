...
procedure with a full-team-first fallback: if no feasible full-team assignment is found within the bounded search, one robot is temporarily
inactive. At $N{=}4$, PushAround uses $29.2$\,s planning and $110.1$\,s execution against $101.9$\,s and $175.9$\,s for DFS-WCCG.
Across the sweep, the branching per expansion stays
