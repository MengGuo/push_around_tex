...
on a computer with an Intel Core i9-14900KF CPU and an NVIDIA RTX 4080 GPU.
...
Moreover, \textbf{internal ablations} remove key modules of \textbf{PushAround}: \textbf{w/o presearch}, which disables frontier extraction and
...
Lastly, \textbf{scalability} is examined in an $8{\times}5$\,m workspace containing $30$ movable objects. Although
...
fails to produce complete solutions. Overall,
...
\begin{figure}[t!]
  \centering
  \includegraphics[width=0.9\columnwidth]{figures/Rec_NAMO.png}
  \vspace{-0.2in}
