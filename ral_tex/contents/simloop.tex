...
The proposed physics-informed hybrid search
(PIHS) selects blocking gaps and validates the corresponding multi-robot
pushing strategies through short-horizon simulation,
as shown in Fig.~\ref{fig:PIHS} and summarized in Alg.~\ref{alg:pihs}.
Unlike purely geometric
NAMO planners, PIHS expands only physics-validated strategies. Candidate
strategies are evaluated in parallel.
