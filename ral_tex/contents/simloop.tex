...
couples high-level selection of blocking gaps with
the generation and physics validation of multi-robot pushing strategies.
Unlike purely geometric NAMO planners that expand abstract obstacle
displacements, PIHS admits only strategies validated by short-horizon simulation.
Candidate strategies are evaluated in parallel, 
and Alg.~\ref{alg:push} summarizes the procedure described below.
