...
and {(II)} \change{ 
it demonstrates substantial empirical improvements in feasibility, efficiency and scalability over the evaluated NAMO and collaborative-clearing baselines, 
together with robustness to execution-side physical-parameter mismatch.
}