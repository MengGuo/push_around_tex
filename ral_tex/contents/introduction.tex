...
\begin{figure}[t!]
  \centering
  \includegraphics[width=0.8\linewidth]{figures/cover.png}% or {presearch.pdf}
  \vspace{-0.1in}
  \caption{
...
\begin{figure*}[t!]
  \centering
  \includegraphics[width=0.8\linewidth]{figures/overall.pdf}
  \vspace{-0.1in}
