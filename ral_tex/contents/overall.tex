...
substitutions rather than $|\mathcal{A}|^N$ joint tuples, and refinement is capped by a fixed evaluation
budget; failures are handled by bounded backtracking with budget $B{=}2000$ and a reduced-team
fallback over at most $N$ one-robot-excluded subsets. Each candidate is checked by an LP over at most $2N$ contact-force variables.}
%% %----------------------------------------------
