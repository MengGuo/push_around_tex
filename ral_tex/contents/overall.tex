...
subset fallback repeats this search for at most one excluded robot. The per-task
cost is therefore at most $(N|\mathcal{A}|{+}2B)$ LP feasibility checks over the
$2N$ admissible contact forces, rather than growing as $|\mathcal{A}|^N$.}
%% %----------------------------------------------
