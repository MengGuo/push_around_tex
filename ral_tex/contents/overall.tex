...
robot, rather than $|\mathcal{A}|^N$ joint tuples, and refinement is capped by a bounded evaluation budget; failures are handled by bounded backtracking with budget $B$ and a reduced-team fallback over
