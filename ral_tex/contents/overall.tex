...
$\partial\Omega_m$~\cite{tang2024collaborative}, which reduces path crossings
when sufficient clearance exists. If nearby obstacles block the reassignment,
the candidate is rejected during rollout.
