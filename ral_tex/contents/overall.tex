...
generation: each greedy sweep evaluates at most $N|\mathcal{A}|$ single-contact
substitutions rather than the exhaustive $|\mathcal{A}|^N$ assignment, while refinement is capped by a fixed evaluation budget; if it 
